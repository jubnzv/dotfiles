...
complete -c fd -n "__fish_use_subcommand" -l changed-within -d 'Limit results based on modification time within the duration provided or between date provided and now.'
complete -c fd -n "__fish_use_subcommand" -l changed-before -d 'Limit results based on modification time older than duration or date provided.'
