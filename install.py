...
class Configuration:
    ...
    DOTFILES = {
        ...
        '.config/nvim/lua/nvim-colorizer.lua':    '~/.config/nvim/lua/',
        ...
        '.config/nvim/UltiSnips/yacc.snippets':   '~/.config/nvim/UltiSnips/',
        '.config/nvim/UltiSnips/lex.snippets':    '~/.config/nvim/UltiSnips/',
        '.config/nvim/UltiSnips/lua.snippets':    '~/.config/nvim/UltiSnips/',
