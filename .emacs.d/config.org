...
(add-to-list 'org-structure-template-alist '("sb" "#+BEGIN_SRC bash\n?\n#+END_SRC" "<src lang=\"bash\">\n?\n</src>"))
(add-to-list 'org-structure-template-alist '("spl" "#+BEGIN_SRC plant-uml :file img/ \n?\n#+END_SRC"))
(add-to-list 'org-structure-template-alist '("ss" "#+BEGIN_SRC shell\n?\n#+END_SRC"))
(add-to-list 'org-structure-template-alist '("sS" "#+BEGIN_SRC shell :dir \"/sudo::\"\n?\n#+END_SRC"))
#+END_SRC

** org modules

Org-mode Contributed Packages which already included in default Emacs installation but requires additional loading. See complete list with descriptions [[https://orgmode.org/worg/org-contrib/][here]].

*** =org-drill=

Flashcards and spaced repetition for org-mode. See description with usage examples [[https://orgmode.org/worg/org-contrib/org-drill.html][here]].
#+BEGIN_SRC emacs-lisp
(require 'org-drill)
#+END_SRC
...
=org-inlinetask.elc= is already included in Emacs 26.1 package from Debian 10.
#+BEGIN_SRC emacs-lisp
(require 'org-inlinetask)
#+end_src

#+BEGIN_SRC emacs-lisp
(evil-declare-key 'normal org-mode-map ",i" 'org-inlinetask-insert-task)
#+end_src
...
(define-key evil-leader-map "ft"  'projectile-find-tag)
#+END_SRC
...
=rainbow-delimiters= mode is too distracting for languages other than lisp.
#+BEGIN_SRC emacs-lisp
