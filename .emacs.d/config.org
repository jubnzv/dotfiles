...
Fold everything but the current headline.
See this [[https://stackoverflow.com/questions/25161792/emacs-org-mode-how-can-i-fold-everything-but-the-current-headline][stackoverflow question]].
...
[[https://github.com/Kungsgeten/org-brain][org-brain]] is a plugin that implements a variant of concept mapping in Emacs, using org-mode.
...
Keybindings:
#+BEGIN_SRC emacs-lisp
(evil-declare-key 'normal org-mode-map ",bv" 'org-brain-visualize)
#+END_SRC
