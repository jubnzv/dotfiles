...
Show system-wide notifications with =libnotify=:
#+begin_src emacs-lisp
...
(evil-leader/set-key "vR"  'magit-reset-popup)
(evil-leader/set-key "vd"  'magit-diff-popup)
(evil-leader/set-key "vb"  'magit-branch-popup)
(evil-leader/set-key "vh"  'magit-stash-popup)
(evil-leader/set-key "vl"  'magit-log-popup)
(evil-leader/set-key "vp"  'magit-push-popup)
(evil-leader/set-key "vr"  'magit-remote-popup)
#+END_SRC
...
(evil-leader/set-key "Cl"  'clm/toggle-command-log-buffer)
